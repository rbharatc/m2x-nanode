...
HTML documentation can be generated by running the command `make docs` from the root of the application directory. Doxygen is used to generate the documentation from the source code and it uses the file named Doxyfile in the docs/ folder to set the doxygen configuration. Output is a html folder with the generated documentation inside the /docs folder.

To know more about doxygen tool, visit [Doxygen page](http://www.stack.nl/%7Edimitri/doxygen/manual/index.html)
